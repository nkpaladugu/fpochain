...
import "./FarmProducts.sol";
import "./Users.sol";

/**
 * @title 
 * @author 
 * @dev Implements the transparency in the fpo chain to
 * understand the actual user & the flow of the produce
 */
contract FPOChain is Users, Products {
     ...
     */
    function getAllFarmProducts() public view returns (Types.Product[] memory) {
        return products;
    }
